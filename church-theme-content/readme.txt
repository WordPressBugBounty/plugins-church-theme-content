...
Provides an interface for managing sermons, events, people and locations. A **compatible theme is required** for presenting content from these church-centric post types in a tightly-integrated manner.
...
Please see our [Plugin Installation](https://churchthemes.com/guides/user/plugins/plugin-installation/) guide for additional information.
...
Yes, please see the [Developer Guide](https://churchthemes.com/guides/developer/church-content/).
